...
#include "ElectrokineticCellZoneInjection.H"
...
void Foam::ElectrokineticCellZoneInjection<CloudType>::setPositions
(
...
template<class CloudType>
Foam::ElectrokineticCellZoneInjection<CloudType>::ElectrokineticCellZoneInjection
(
...
:
	...
	z0_(readScalar(this->coeffDict().lookup("z0"))),
...
Foam::ElectrokineticCellZoneInjection<CloudType>::ElectrokineticCellZoneInjection
(
    const ElectrokineticCellZoneInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::ElectrokineticCellZoneInjection<CloudType>::updateMesh()
{
    ...
    if (zoneI < 0)
    {
        FatalErrorIn("Foam::ElectrokineticCellZoneInjection<CloudType>::updateMesh()")
    ...
    {
        WarningIn("Foam::ElectrokineticCellZoneInjection<CloudType>::updateMesh()")
...
template<class CloudType>
Foam::scalar Foam::ElectrokineticCellZoneInjection<CloudType>::timeEnd() const
{
    // Not used
    return this->SOI_;
}
...
template<class CloudType>
Foam::label Foam::ElectrokineticCellZoneInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::ElectrokineticCellZoneInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::ElectrokineticCellZoneInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::ElectrokineticCellZoneInjection<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::ElectrokineticCellZoneInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::ElectrokineticCellZoneInjection<CloudType>::validInjection(const label)
{
    return true;
}
