...
#include "ParticleMassFlowRate.H"
#include "Pstream.H"
...
void Foam::ParticleMassFlowRate<CloudType>::makeLogFile
(
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::initPolygons()
{
    mode_ = mtPolygon;
    ...
    forAll(polygons, polyI)
    {
        ...
        if (np < 3)
        {
            FatalIOErrorIn
            (
                "Foam::ParticleMassFlowRate<CloudType>::initPolygons()",
                this->coeffDict()
            )
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::initConcentricCircles()
{
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::collectParcelPolygon
(
    const point& p1,
    const point& p2
) const
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::collectParcelConcentricCircles
(
    const point& p1,
    const point& p2
) const
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::write()
{
    ...
    Info<< "    total mass = " << sumTotalMass << nl
        << "    average mass flow rate = " << sumAverageMFR << nl
        << endl;
...
template<class CloudType>
Foam::ParticleMassFlowRate<CloudType>::ParticleMassFlowRate
(
...
Foam::ParticleMassFlowRate<CloudType>::ParticleMassFlowRate
(
    const ParticleMassFlowRate<CloudType>& pc
)
:
...
template<class CloudType>
void Foam::ParticleMassFlowRate<CloudType>::postMove
(
    const parcelType& p,
    const label cellI,
    const scalar dt,
